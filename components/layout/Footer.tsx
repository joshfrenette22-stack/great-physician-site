...
export function Footer() {
  return (
    <footer className="border-t border-gray-200 bg-gray-50">
      <div className="max-w-[1240px] mx-auto px-10 pt-14 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] gap-10">
        {/* Brand */}
        <div>
          <Logo height={34} />
        ...
        {/* Explore */}
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-[0.16em] text-gray-400 mb-3.5">Explore</h4>
        ...
        {/* Practice */}
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-[0.16em] text-gray-400 mb-3.5">Practice</h4>
          <nav className="flex flex-col gap-2.5">
        ...
        {/* Visit */}
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-[0.16em] text-gray-400 mb-3.5">Visit</h4>
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-[1240px] mx-auto px-10 py-[18px] flex flex-wrap gap-3 items-center text-[13px] text-gray-400">
          <span>&copy; {new Date().getFullYear()} Great Physician Regenerative Medicine</span>
          <Link href="/privacy" className="text-gray-400 hover:text-teal-600 transition-colors">Privacy</Link>
          <Link href="/terms" className="text-gray-400 hover:text-teal-600 transition-colors">Terms</Link>
