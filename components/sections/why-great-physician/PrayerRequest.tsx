          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center px-6 py-3.5 rounded-lg font-semibold text-base text-white bg-teal-600 hover:bg-teal-700 disabled:opacity-60 disabled:pointer-events-none transition-all duration-200 shadow-sm"
              >
